...
/* ---- Configuration ---- */
#define ANALYSER_CORPUS "c_lottery_analyser.txt"
#define PREDICTOR_CORPUS "c_lottery_predictor.txt"
#define CSV_FILE "c_euromillions-draw-history.csv"

#define ANALYSER_CKPT "c_lottery_analyser.ckpt"
#define PREDICTOR_CKPT "c_lottery_predictor.ckpt"
