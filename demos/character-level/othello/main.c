...
#define PLANNER_CORPUS "c_othello_planner.txt"
#define PLAYER_CORPUS "c_othello_player.txt"
#define PLANNER_CKPT "c_othello_planner.ckpt"
#define PLAYER_CKPT "c_othello_player.ckpt"
