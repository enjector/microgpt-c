...
/* ---- Configuration ---- */
#define PLANNER_CORPUS "c_sudoku_planner.txt"
#define PLAYER_CORPUS "c_sudoku_player.txt"
#define PLANNER_CKPT "c_sudoku_planner.ckpt"
#define PLAYER_CKPT "c_sudoku_player.ckpt"
