...
#define PLANNER_CORPUS "c_pentago_planner.txt"
#define PLAYER_CORPUS "c_pentago_player.txt"
#define PLANNER_CKPT "c_pentago_planner.ckpt"
#define PLAYER_CKPT "c_pentago_player.ckpt"
