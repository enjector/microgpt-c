...
#define PLANNER_CORPUS (GRID == 5 ? "c_hex5_planner.txt" : "c_hex_planner.txt")
#define PLAYER_CORPUS (GRID == 5 ? "c_hex5_player.txt" : "c_hex_player.txt")
#define PLANNER_CKPT (GRID == 5 ? "c_hex5_planner.ckpt" : "c_hex_planner.ckpt")
#define PLAYER_CKPT (GRID == 5 ? "c_hex5_player.ckpt" : "c_hex_player.ckpt")
