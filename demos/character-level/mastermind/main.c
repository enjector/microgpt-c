...
/* ---- Configuration ---- */
#define PLANNER_CORPUS "c_mastermind_planner.txt"
#define PLAYER_CORPUS "c_mastermind_player.txt"

#define PLANNER_CKPT "c_mastermind_planner.ckpt"
#define PLAYER_CKPT "c_mastermind_player.ckpt"
