...
/* ---- Configuration ---- */
#define PLANNER_CORPUS "c_tictactoe_planner.txt"
#define PLAYER_CORPUS "c_tictactoe_player.txt"

#define PLANNER_CKPT "c_tictactoe_planner.ckpt"
#define PLAYER_CKPT "c_tictactoe_player.ckpt"
