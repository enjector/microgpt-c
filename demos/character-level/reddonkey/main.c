...
#define PLANNER_CORPUS                                                         \
  (ROWS == 5 ? "c_rd54_planner.txt" : "c_reddonkey_planner.txt")
#define PLAYER_CORPUS (ROWS == 5 ? "c_rd54_player.txt" : "c_reddonkey_player.txt")
#define PLANNER_CKPT                                                           \
  (ROWS == 5 ? "c_rd54_planner.ckpt" : "c_reddonkey_planner.ckpt")
#define PLAYER_CKPT (ROWS == 5 ? "c_rd54_player.ckpt" : "c_reddonkey_player.ckpt")
