...
/* ---- Configuration ---- */
#define PLANNER_CORPUS "c_lightsout_planner.txt"
#define PLAYER_CORPUS "c_lightsout_player.txt"

#define PLANNER_CKPT "c_lightsout_planner.ckpt"
#define PLAYER_CKPT "c_lightsout_player.ckpt"
