...
/* ---- Configuration ---- */
#define STRATEGIST_CORPUS "c_puzzle8_strategist.txt"
#define MOVER_CORPUS_STD "c_puzzle8_mover.txt"
#define MOVER_CORPUS_ENRICHED "c_puzzle8_mover_enriched.txt"
#define MOVER_CORPUS_COMBINED "c_puzzle8_mover_combined.txt"
#define DETECTOR_CORPUS "c_puzzle8_detour_detector.txt"
#define DETOUR_MOVER_CORPUS "c_puzzle8_detour_mover.txt"
#define JUDGE_CORPUS "c_puzzle8_judge.txt"
...
#define STRATEGIST_CKPT "c_puzzle8_strategist_v3b.ckpt"
#define MOVER_CKPT "c_puzzle8_mover_v3b.ckpt"
#define DETECTOR_CKPT "c_puzzle8_detector_v3b.ckpt"
#define DETOUR_MOVER_CKPT "c_puzzle8_detour_mover_v3b.ckpt"
#define JUDGE_CKPT "c_puzzle8_judge_v3b.ckpt"
...
#define TRACE_OUTPUT_FILE "c_puzzle8_reasoning_traces.txt"
#define ENRICHED_CORPUS_FILE "c_puzzle8_mover_enriched.txt"
...
int main(void) {
  ...
  const char *mover_ckpt =
      (USE_ENRICHED_CORPUS == 2)   ? "c_puzzle8_mover_combined_v3b.ckpt"
      : (USE_ENRICHED_CORPUS == 1) ? "c_puzzle8_mover_enriched_v3b.ckpt"
                                   : MOVER_CKPT;
