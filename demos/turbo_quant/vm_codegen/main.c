...
#ifdef ENABLE_TURBOQUANT
  turboquant_init(&g_tq, cfg.n_embd, 3, true);
  printf("TurboQuant enabled: 3-bit MSE + 1-bit QJL chunk storage.\n");
#else
  printf("TurboQuant DISABLED. Running baseline MSA (FP32 floats).\n");
#endif
