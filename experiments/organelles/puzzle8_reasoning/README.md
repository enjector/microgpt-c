...
The reasoning trace experiment tests whether enriching the training corpus with **pipeline process knowledge** (stall counts, move history, blocked directions) improves performance. See [ORGANELLE_REASONING.md](../../docs/organelles/ORGANELLE_REASONING.md) §9.8 for full methodology.
