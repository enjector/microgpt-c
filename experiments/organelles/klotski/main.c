...
#define PLANNER_CORPUS "klotski_planner.txt"
#define PLAYER_CORPUS "klotski_player.txt"
#define PLANNER_CKPT "klotski_planner.ckpt"
#define PLAYER_CKPT "klotski_player.ckpt"
