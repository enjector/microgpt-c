...
size_t text_len;
char *text = load_file("c_shakespeare.txt", &text_len);
...
| [`demos/character-level/vm_codegen/`](file:///Users/user/dev/projects/microgpt-c/demos/character-level/vm_codegen) | 500 words | <0.1% | Constrained DSL — **80% syntax pass** |
