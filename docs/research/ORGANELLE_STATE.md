...
The three productisation verticals (`docs/PRODUCT_FRAUD_DETECTION.md`, `docs/PRODUCT_FINANCE_RISK.md`, `docs/PRODUCT_DEFENCE_TRACKING.md`) are not just commercial moves — they're **the next round of organelle research on real-world data**. Each vertical exercises a different bound:
