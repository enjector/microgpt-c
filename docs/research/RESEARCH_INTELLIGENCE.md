...
- [`mastermind/main.c`](../../demos/character-level/mastermind/main.c) — RANDOM_BASELINE + attribution
- [`connect4/main.c`](../../demos/character-level/connect4/main.c) — RANDOM_BASELINE + attribution
...
- [`mastermind_planner.ckpt.log`](../../models/organelles/character-level/mastermind_planner.ckpt.log)
- [`mastermind_player.ckpt.log`](../../models/organelles/character-level/mastermind_player.ckpt.log)
- [`connect4_planner.ckpt.log`](../../models/organelles/character-level/connect4_planner.ckpt.log)
- [`connect4_player.ckpt.log`](../../models/organelles/character-level/connect4_player.ckpt.log)
