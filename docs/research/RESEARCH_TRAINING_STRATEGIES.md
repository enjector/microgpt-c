...
**Proof:** c99_compose at 462K (WARMUP_STEPS=100, lr=0.001): best loss 0.072, 96% parse. c99_compose at 1.2M (same settings): loss diverged to 2.0+ at step 7K, 20% parse.
...
4. [Empirical Evidence: c99_compose Experiments](#4-empirical-evidence-c99_compose-experiments)
...
| 96/8/4 (c99_compose v1) | 462K | 0.001 | - | 0.001 |
| 128/8/6 (c99_compose v2) | 1.2M | - | 0.001 × √(462K/1.2M) = 0.0006 | **0.0005** |
...
## 4. Empirical Evidence: c99_compose Experiments

Three experiments on the c99_compose pipeline (intent → function plan):
...
### Small (100K–500K params) — c_codegen, c99_compose v1
...
### Medium (500K–2M params) — c99_compose v3, game demos
