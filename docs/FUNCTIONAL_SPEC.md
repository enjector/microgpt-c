...
Docs docs;
load_docs("c_names.txt", &docs, cfg.max_docs);  // Load line-separated training data
...
```c
size_t len;
char *text = load_file("c_shakespeare.txt", &len);
...
See [`demos/character-level/names/main.c`](../demos/character-level/names/main.c) (character-level), [`demos/character-level/shakespeare/main.c`](../demos/character-level/shakespeare/main.c) (character-level, multi-threaded), and [`demos/character-level/c_codegen/main.c`](../demos/character-level/c_codegen/main.c) (875K-param C code generation) for full working programs.
