...
#ifndef PIPELINE_IR_H
#define PIPELINE_IR_H

/* Legacy include-guard alias retained so any external code that
 * historically `#ifdef`-tested the old MicroGPT-C symbol still finds
 * it defined.  New code should use the PIPELINE_IR_H name above. */
 ...
 *   MINOR — additive ABI extensions
 *   PATCH — bug fixes only
 *
 * Library currently ships as a pre-v1 candidate at 0.1.0; the API is
 * "experimental, stable for the symbols documented in the README's
 * stability table" until v1.0.0. */
#define PIPELINE_IR_API_VERSION_MAJOR 0
#define PIPELINE_IR_API_VERSION_MINOR 1
#define PIPELINE_IR_API_VERSION_PATCH 0
